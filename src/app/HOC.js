...
export const stracture = {
    ...
    children: [
        ...
        {
            type: 'TitleItem',
            title: '35. Условия труда работников и мероприятия, обеспечивающие требования охраны труда при эксплуатации',
            icon: '',
            variable: '',
        },
        {
            type: 'selectItem',
            title: 'Условия труда работников и мероприятия, обеспечивающие требования охраны труда при эксплуатации',
            icon: '',
            variable: 'working_conditions_employees_activities',
            options: [
                {
                    label: 'Производственных и непроизводственных объектов капитального строительства',
                    id: 'Производственных и непроизводственных объектов капитального строительства',
                },
                {
                    label: 'Линейного объекта',
                    id: 'Линейного объекта',
                },
            ],
        },
        {
            type: 'TitleItem',
            title: '36. Требования по ассимиляции производства',
            icon: '',
            variable: '',
        },
        {
            type: 'TitleItem',
            title: '37. Требования к разработке перечня мероприятий по гражданской обороне, мероприятий по предупреждению чрезвычайных ситуаций природного и техногенного характера',
            icon: '',
            variable: '',
        },
        {
            type: 'selectItem',
            title: 'Требования к разработке перечня мероприятий по гражданской обороне, мероприятий по предупреждению чрезвычайных ситуаций природного и техногенного характера',
            icon: '',
            variable: 'requirements_development_list_civil_defense_measures',
            options: [
                {
                    label: 'Требуется',
                    id: 'Требуется',
        ...
        {
            type: 'TitleItem',
            title: '38. Требования по пожарной безопасности',
            icon: '',
            variable: '',
        },
        {
            type: 'TitleItem',
            title: '39. Требования к разработке перечня мероприятий по гражданской обороне, мероприятий по предупреждению чрезвычайных ситуаций природного и техногенного характера',
            icon: '',
            variable: '',
        },
        {
            type: 'selectItem',
            title: '39.2. При разработке проектных решений по оснащению объектов инженерно-техническими средствами охраны руководствоваться требованиями',
            icon: '',
            variable: 'requirements_development_list_civil_defense_measures',
            options: [
                {
                    label: 'Федерального закона от 21 июля 2011 г. № 256-ФЗ «О безопасности объектов топливно-энергетического комплекса»',
                    id: 'Федерального закона от 21 июля 2011 г. № 256-ФЗ «О безопасности объектов топливно-энергетического комплекса»',
                },
                {
                    label: 'Федерального закона от 21 июля 2011 г. № 256-ФЗ «О безопасности объектов топливно-энергетического комплекса»',
                    id: 'Федерального закона от 21 июля 2011 г. № 256-ФЗ «О безопасности объектов топливно-энергетического комплекса»',
                ...
                {
                    label: 'положениями «Требований к обеспечению безопасности линейных объектов топливно-энергетического комплекса», утвержденных постановлением Правительства ',
                    id: 'положениями «Требований к обеспечению безопасности линейных объектов топливно-энергетического комплекса», утвержденных постановлением Правительства ',
                },
                {
                    label: 'Российской Федерации от 19 сентября 2015 г. № 993',
                    id: 'Российской Федерации от 19 сентября 2015 г. № 993',
                },
            ],
        },
        {
            type: 'TitleItem',
            title: 'Реализовать подсистему/подсистемы',
            icon: '',
            variable: '',
        },
        {
