        ...
        <div className="right-side">
            ...
            <StepItem
                ...
                title="Этапы проектирования" /> */}
                    ...
                    <UpploadFile />
                    <Text className="project-name" size="s">
                        11.2 Заключение о результатах экспертизы ПАО «Газпром»
                    ...
                    <UpploadFile />
                    <Text className="project-name" size="s">
                        11.4 Действующие проектные документы на разработку
                        месторождений, согласованные ЦКР Роснедр по УВС
                    </Text>
                    <UpploadFile />
                    <Text className="project-name" size="s">
                        11.5 Проектная документация Наименование, шифр
                        (договор), утвержденная в соответствующем порядке
                    </Text>
                    <UpploadFile />
                    <Text className="project-name" size="s">
                        11.6 НИР по тематике, связанной с объектом
                        проектирования
                    </Text>
                    <UpploadFile />
                    <Text className="project-name" size="s">
                        11.7 Отчет по сбору исходных данных для определения
                        объема проектно-изыскательских работ (Этап 1)
                    </Text>
                    <UpploadFile />
                    <Text className="project-name" size="s">
                        11.7 Отчет по сбору исходных данных для определения
                    ...
                    <UpploadFile />
                    <Text className="project-name" size="s">
                        11.8 Технические требования на проектирование «Название
                        объекта или системы в точном соответствии с Планом ПИР»
                    </Text>
                    <UpploadFile />
                    <Text className="project-name" size="s">
                        11.9 Технические требования на проектирование «Название
                        объекта или системы в точном соответствии с Планом ПИР
                        (комплекс инженерно-технических средств охраны)
                    </Text>
                    <UpploadFile />
                    <Text className="project-name" size="s">
                        11.10 Технические требования на проектирование
                        подсистемы безопасности объекта критической
